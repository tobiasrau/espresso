...
\begin{pysyntax}
  \object{
    espressomd.System.integrator
  }{
    run
  }{
    steps = \arg{int},
  }[
    recalc_forces = \arg{bool},
    reuse_forces = \arg{bool}
  ]
  \object{
    espressomd.System.integrator
  }{
...
The \texttt{set\_steepest\_descent} command tells the integrator to perform steps with the steepest descent algorithm rather than with the velocity verlet algorithm. Performing \texttt{integrator.run(steps=n\_steps)} runs the steepes descent algorithm.
